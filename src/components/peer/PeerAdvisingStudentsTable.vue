  ...
  <div class="student-table-wrapper">
    ...
    >
      ...
      <tbody class="d-block w-100">
        ...
        >
          <!-- Student Name -->
          <td class="td-student" :class="{ 'd-contents': !smAndDown }">
            <div class="grid-cell">
          ...
          <!-- UID -->
          <td class="td-uid" :class="{ 'd-contents': !smAndDown }">
            <div class="grid-cell">
          ...
          <!-- Email -->
          <td class="td-email" :class="{ 'd-contents': !smAndDown }">
            <div class="grid-cell">
              <a
          ...
          <!-- Expand/Collapse -->
          <td class="td-expand" :class="{ 'd-contents': !smAndDown }">
...
/* Layout: Name | UID | Email | Expand button */
...
/* Column placement */
.td-student .grid-cell { grid-area: 1 / 1 / 1 / 1; min-width: 180px; }
.td-uid .grid-cell     { grid-area: 1 / 2 / 1 / 2; }
.td-email .grid-cell   { grid-area: 1 / 3 / 1 / 3; }
.td-expand .grid-cell  { grid-area: 1 / 4 / 1 / 4; }

/* Expansion spans full width as second grid row */
