...
export default {
  ...
  data: () => ({
    degreeChecks: [
      {name: 'Bioengineering 2019', createdAt: '2019-07-18', id: 0},
      {name: 'Bioengineering 2020', createdAt: '2019-07-18', id: 1},
      {name: 'Bioengineering 2021', createdAt: '2019-07-18', id: 2},
    ]
  }),
  mounted() {
