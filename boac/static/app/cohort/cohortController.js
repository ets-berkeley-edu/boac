(function(angular) {
  ...
  angular.module('boac').controller('CohortController', function(cohortFactory, authService, $rootScope, $scope, $state, $stateParams) {

    var loadCohort = function() {
    ...
    $rootScope.$on('userStatusChange', loadCohort);
